...
- **Docker self-hosting on AWS**: Hosted 20 open source services (Fediverse, Gitea, Database, and my own Next.js apps) on EC2 with Docker, nginx, AWS lambda | [Source Code](https://github.com/jimchen2/cloud-setup) _2024.5-2024.9_
