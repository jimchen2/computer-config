// ==UserScript==
// @name         Video Sites Shortcuts & TikTok Background Play
// @namespace    http://tampermonkey.net/
// @version      1.2
// @license      Unlicense
// @description  Combines TikTok background play with keyboard shortcuts for various video sites.
// @author       You & Jim Chen
// @match        *://*.tiktok.com/*
// @match        *://*.bilibili.com/*
// @match        *://vkvideo.ru/*
...
(function () {
    ...
    // ==========================================
    // TIKTOK BACKGROUND PLAY LOGIC
    // ==========================================
    if (hostname.includes("tiktok.com")) {
        // Spoof the Page Visibility API so the browser always reports the tab as 'visible'
        ...
        // Intercept and block the 'visibilitychange' event from reaching TikTok's scripts
        document.addEventListener('visibilitychange', function(event) {
            event.stopImmediatePropagation();
        }, true);

        // Some sites also check the window blur/focus events. Blocking these just in case.
